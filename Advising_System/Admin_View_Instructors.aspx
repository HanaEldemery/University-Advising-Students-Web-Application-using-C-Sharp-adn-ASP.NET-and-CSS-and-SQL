<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Instructors.aspx.cs" Inherits="Advising_System.Admin_View_Instructors" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewInstructors" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
