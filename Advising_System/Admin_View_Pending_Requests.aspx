<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Pending_Requests.aspx.cs" Inherits="Advising_System.Admin_View_Pending_Requests" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewRequests" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
