<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Student_Details.aspx.cs" Inherits="Advising_System.Admin_View_Student_Details" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewStudents" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
