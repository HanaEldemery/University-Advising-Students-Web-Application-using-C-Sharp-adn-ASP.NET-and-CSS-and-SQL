...
{
    public partial class View_Optional : System.Web.UI.Page
    {
        ...
        protected void viewOptional(object sender, EventArgs e)
        {
            ...
            else if (!IsSemCodeExists(connStr, semCode1))
            {
            ...
            {
                conn.Open();
                Response.Redirect("View Optional 2.aspx");
                conn.Close();
            }
        }

        static bool IsSemCodeExists(string connectionString, String semCode)
        {
