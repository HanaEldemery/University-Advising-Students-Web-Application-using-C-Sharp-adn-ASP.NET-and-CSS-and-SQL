...
{
    public partial class RedirectSecMakeup : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (datatable == null || datatable.Rows.Count == 0)//msh mohema hena el function bt3melaha check
            {
                Response.Write("Not Eligible for Second Makeup");
            }
            else
            {
                Response.Write("Eligible for Second Makeup");
            }
        }
