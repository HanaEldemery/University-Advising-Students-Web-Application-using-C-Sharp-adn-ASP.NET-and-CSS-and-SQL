<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Advisors.aspx.cs" Inherits="Advising_System.Admin_View_Advisors" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewAdvisors" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
