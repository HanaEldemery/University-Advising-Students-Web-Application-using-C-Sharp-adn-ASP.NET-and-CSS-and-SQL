<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Semesters.aspx.cs" Inherits="Advising_System.Admin_View_Semesters" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewSemesters" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
