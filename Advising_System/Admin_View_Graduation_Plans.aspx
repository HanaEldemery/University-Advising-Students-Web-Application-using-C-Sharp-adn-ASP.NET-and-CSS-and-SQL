<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_View_Graduation_Plans.aspx.cs" Inherits="Advising_System.Admin_View_Graduation_Plans" %>
...
<body>
    <form id="form3" runat="server">
        ...
        <div>
            <asp:GridView ID="viewGPlans" runat="server"  AutoGenerateColumns="True"></asp:GridView>
        </div>
    </form>
</body>
</html>
