...
CREATE PROC [Procedures_StudentRegistration]
    ...
    Select @Student_id =  student_id from Student 
     ...
     email = @email 
     --added
     update student set financial_status=1 where student_id=@Student_id
     --done added
...
select * from student
update student set major='met' where student_id=1 
update student set financial_status=1 where student_id=33 
update student set financial_status=1 where student_id=34
update student set financial_status=1 where student_id=30
select * from Student_Instructor_Course_take
select * from course
select * from slot
insert into slot
values(1,'Fro','s','s',1,1);
insert into slot
values(2,'Fro','s','s',2,1);
select * from instructor
INSERT INTO Student_Instructor_Course_take
VALUES(1,3,1,'W23','Normal','F');

select * from Student_Phone
delete from request where type='' or course_id='' 
select * from request

print dbo.FN_StudentCheckSMEligibility(3,1)
EXEC Procedures_StudentRegisterSecondMakeup 1,3,'W23'


select * from Student_Phone
select * from Request
exec Procedures_ViewOptionalCourse 1, w23
exec Procedures_ViewOptionalCourse 1, w24
...
select * from dbo.FN_SemsterAvailableCourses('224')

INSERT INTO Student_Instructor_Course_Take (student_id, course_id, instructor_id, semester_code,exam_type, grade) 
VALUES (1, 1, 1, 'W23', 'Normal', 'F')
INSERT INTO Student_Instructor_Course_Take (student_id, course_id, instructor_id, semester_code,exam_type, grade) 
VALUES (1, 2, 1, 'W23', 'Normal', 'F')
update Student_Instructor_Course_Take set exam_type='Second Makeup',semester_code='w22' where course_id=1
select * from Student_Instructor_Course_Take
...
insert into semester(semester_code)
values('s25')
select * from dbo.FN_SemsterAvailableCourses('s25')
...
Declare @o Bit
Set @o= dbo.FN_StudentCheckSMEligibility(3,1)
print @o
...
INSERT INTO Payment(payment_id,amount,startdate,deadline,n_installments,status,student_id,semester_code)
VALUES(1,10000,'10/10/2023','7/10/2024',10,'NotPaid',1,'W23');

EXEC Procedures_AdminIssueInstallment @payment_id=1;
SELECT * FROM Payment
SELECT * FROM Installment
UPDATE Installment
SET status='Paid'
WHERE deadline='2023-11-10'
UPDATE Installment
SET status='Paid'
WHERE deadline='2023-12-10'
UPDATE Installment
SET status='Paid'
WHERE deadline='2024-01-10'
UPDATE Installment
SET status='Paid'
WHERE deadline='2024-02-10'
